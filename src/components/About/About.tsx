...
const About = () => {
  return (
    <div className="px-8 py-[50px] md:py-[100px] flex flex-col justify-center items-start md:items-center md:flex-row ">
        ...
        <div className="flex flex-col gap-4 ">
          <div className="flex flex-col md:flex-row">
            <div className="flex flex-col border border-orange-400 border-solid p-2">
              <Image src="/About/PartyIcon.png" alt="" width={30} height={30} />
